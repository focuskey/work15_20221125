...
class Book(models.Model):
    ...
    roll_price = fields.Float('Roll Price', digits=(12, 2), readonly=True, compute="_compute_roll")
    ...
    discount = fields.Float('Discount', default=1, groups="carpetcall_franchise.carpetcall_group_user")
    ...
    comment = fields.Text("Comment", readonly=False, default="This is the commment to edit fields.")
    ...
    discount2 = fields.Float(string="Discount_k", related="build_id.discount", readonly=False)
